...
4. Ensure task discovery points at the provisioning-refactor task set rather
   than stale Phase 04c task docs.

## Postconditions

- No active refactor instruction points agents at the deprecated MikroTik static
  DNS path for lab browser records.
- The new 22-task sequence is discoverable from the README and task sequence.

## Validation

- `rg -n "LEGACY|superseded_by|docs/provisioning-refactor" docs/plan/phase-04c-stack-owned-ingress-auth-dns.md`

...
10 (runbook + docs sync) ─── 11 (SDN destroy no-op handling) ─── 12 (stack-only rebuild-gate contract)
```
...
After all tasks are complete, including Task 12 and any rebuild-unblocker tasks opened by a

...
|---|---|---|---|---|
| 0 | Route and API smoke check | `Use only 192.168.70.12. Check whether TCP ports 8080 and 6379 are reachable. Report only the two results, then stop.` | Exactly those two endpoints checked; no scope drift; flow terminates cleanly. | 10 min |

#!/usr/bin/env python3
"""
Archived debug helper from session 39: NetBox IP/VM quick lookup.

Moved to .archive because this was a short-lived interactive helper.
Keep for operator reference but not executed by CI.
"""
